...
Required:
    MLFLOW_S3_ACCESS_KEY    - MinIO access key
    MLFLOW_S3_SECRET_KEY    - MinIO secret key

Optional:
    MLFLOW_TRACKING_URI     - MLflow server URI
    MLFLOW_S3_ENDPOINT_URL  - S3 endpoint URL
...
# ========== PATH CONFIGURATION ==========
SCRIPT_PATH = Path(__file__).resolve()  # /pricing__epac/src/machine_learning/training/train_and_compare.py
...
os.environ['AWS_ACCESS_KEY_ID'] = os.getenv('MLFLOW_S3_ACCESS_KEY', settings.AWS_ACCESS_KEY_ID)
os.environ['AWS_SECRET_ACCESS_KEY'] = os.getenv('MLFLOW_S3_SECRET_KEY', settings.AWS_SECRET_ACCESS_KEY)
os.environ['MLFLOW_S3_ENDPOINT_URL'] = os.getenv('MLFLOW_S3_ENDPOINT_URL', settings.MLFLOW_S3_ENDPOINT_URL)
os.environ['AWS_DEFAULT_REGION'] = os.getenv('AWS_DEFAULT_REGION', settings.AWS_DEFAULT_REGION)
