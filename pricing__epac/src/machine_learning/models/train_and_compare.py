...
# ========== PATH CONFIGURATION ==========
SCRIPT_PATH = Path(__file__).resolve()  # /pricing__epac/src/machine_learning/models/training_pipeline.py
PROJECT_ROOT = SCRIPT_PATH.parents[4]
MODELS_DIR = PROJECT_ROOT / "pricing__epac" / "models"
DATA_DIR = PROJECT_ROOT /"pricing__epac" / "data" / "processed"
